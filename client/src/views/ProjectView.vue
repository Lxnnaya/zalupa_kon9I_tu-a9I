  ...
  <div v-if="!isLoading" class="word-editor">
    ...
    <div class="toolbar">
      ...
      <div class="toolbar__row">
        <div :class="{ disabled: currentPage <= 1 }" @click="prevPage"><img
